...
**Пропсы-персонажи (животные/насекомые/главный герой истории):** мягкий
...
не мультфильм и не фото-макро. Все пропсы-персонажи и предметы — на чистом
БЕЛОМ или прозрачном фоне (для вырезания), без сцены/декораций.

**Пропсы-предметы** (камень, зонтик, шарик и т.п.): можно полностью
фотореалистично, тут риска "жути" нет.
